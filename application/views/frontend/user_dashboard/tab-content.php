...
<body>
	...
	<div class="container mt-5 tab-content">
		<div class="tab-pane fade show active" id="step-1" aria-labelledby="step1-tab" role="tabpanel">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="pl-5 pt-2">
						...
						<div class="form-group w-50">
							<input class="form-control mt-3" placeholder="Author Name" type="text" name="username"
								id="username">
							<input type="email" class="form-control mt-4" name="email" id="email"
								placeholder="Author@email">
							<textarea class="form-control mt-4" name="bio" id="bio" rows="3"></textarea>
							<input class="form-control mt-4" placeholder="Author Country" type="text" name="country"
								id="country">
							<input type="password" class="form-control mt-4" placeholder="New Password" name="npassword"
								id="npassword ">
							<input type="password" class="form-control mt-4" placeholder="Repeat New Password"
								name="rpassword" id="rpassword ">
							<input type="password" class="form-control mt-4" placeholder="Current Password"
				...
				<div class="col-md-5 text-center ">
					<p class="bg-dark font-weight-bold text-white mx-auto py-2 w-75">Social and Network
					</p>
					<div class="form-group w-75 mx-auto">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class=" rounded-0 input-group-text" id="basic-addon1"> <i
		...
		<div class="tab-pane fade" id="step-2" aria-labelledby="step2-tab" role="tabpanel">Following
		</div>
		<div class="tab-pane fade" id="step-3" aria-labelledby="step3-tab" role="tabpanel">Setting
		</div>
		<div class="tab-pane fade" id="step-4" aria-labelledby="step4-tab" role="tabpanel">Download
		</div>
		<div class="tab-pane fade" id="step-5" aria-labelledby="step5-tab" role="tabpanel">Favorite
		</div>
		<div class="tab-pane fade" id="step-6" aria-labelledby="step6-tab" role="tabpanel">My Subscription
		</div>
	</div>
